...
function eventTemplate(point) {
  const {type, offers, destination, basePrice, isFavorite} = point;
    ...
    `<li class="trip-events__item">
      <div class="event">
        ...
        <ul class="event__selected-offers">
          ${offers.filter((offer) => offer.isChoosen === true).map((offer) => createOfferTemplate(offer)).join('')}
        </ul>
